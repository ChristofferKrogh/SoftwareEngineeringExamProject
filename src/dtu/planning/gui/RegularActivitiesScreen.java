...
public class RegularActivitiesScreen {
    ...
    private void initialize() {
        ...
        panelRegular.setBorder(BorderFactory.createTitledBorder("Regular Activities"));
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (e.getValueIsAdjusting() == false) {
                    ...
                    if (listSearchResult.getSelectedIndex() == -1) {
                        ...
                        b.append("<b>Assigned Employee:</b> " + selectedRegular.getAssignedEmployees().get(0).toString()
                                + "<br></html>");
        ...
        panelEditDates.setBorder(BorderFactory.createTitledBorder("Edit Epected Start and End"));
    ...
    protected void searchRegActivities() {
        searchResults.clear();
        try {
            planningApp.searchForRegActivitiesByName(searchField.getText()).forEach((m) -> {
