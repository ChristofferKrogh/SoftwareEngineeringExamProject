...
public class CorrectReportedTimeScreen {
    ...
    private void initialize() {
        ...
        panelCorrectTime.setBorder(BorderFactory.createTitledBorder("Correct Reported Time"));
        ...
        btnNext.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (dayComboBox.getSelectedIndex() == 0 || monthComboBox.getSelectedIndex() == 0
                    ...
                    date = new GregorianCalendar(Integer.parseInt(yearComboBox.getSelectedItem().toString()),
        ...
        b = new StringBuffer();
        b.append("<html><h2>Save Change</h2></html>");
    ...
    private void searchTimeRegistrations() {
        ...
        planningApp.getAllTimeRegistrationsForEmployeeOnDate(employee, date).forEach(t -> {
            timeRegistrations.addElement(t);
        });
    }
