...
public class EditProjectScreen {
    ...
    public void initialize() {
        ...
        btnEditActivities.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                // –––––––––––––––––––––––––––––-
                // project.getActivities().forEach((a)-> {System.out.println(a + " (" + a.getExpectedAmountOfHours() + "
                // hours)" + " - " + a.getAssignedEmployees());});
            }
        });
    ...
    public void editProject() {
        ...
        boolean isProjectInternal = internalOrExternalComboBox.getSelectedItem().toString().toLowerCase()
                .equals("internal");
        try {
