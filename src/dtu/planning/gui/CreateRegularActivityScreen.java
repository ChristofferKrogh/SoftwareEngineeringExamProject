...
public class CreateRegularActivityScreen {
    ...
    public CreateRegularActivityScreen(PlanningApp planningApp, RegularActivitiesScreen parentWindow, int firstYear,
            int lastYear) {
    ...
    private void initialize() {
        ...
        panelCreateRegActivity.setBorder(BorderFactory.createTitledBorder("Create Regular Activity"));
        ...
        editDatesString.append(
                "<html><b>Expected Start:</b>&nbsp;&nbsp;&nbsp; week &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; of <br><br>"); // &nbsp;
                                                                                                                                           // is
                                                                                                                                           // a
                                                                                                                                           // space
        editDatesString.append(
                "<b>Expected End:</b>&nbsp;&nbsp;&nbsp;&nbsp; week &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; of </html>");
        ...
        panelCreateRegActivitySuccess.setBorder(BorderFactory.createTitledBorder("Success Message"));
        btnBack = new JButton("Back");
        btnBack.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                setVisible(false);
    ...
    protected void createRegActivity() throws Exception {
        ...
        if (end.before(start)) {
            ...
            regActivity = planningApp.addRegularActivity(new Activity(regActivityNameField.getText(), start, end),
                    listSearchResult.getSelectedValue().getInitials());
        }
    }
