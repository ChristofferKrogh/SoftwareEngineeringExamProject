...
public class CreateEmployeeScreen {
    ...
    public void initialize() {
        ...
        panelCreateEmployee.setBorder(BorderFactory.createTitledBorder("Add Employee"));
    ...
    private void setSuccessMessage() {
        ...
        b.append(
                "<html><h2>The employee called</h2> <h1>" + employee + "</h1> <h2>was added to the system</h2></html>");
