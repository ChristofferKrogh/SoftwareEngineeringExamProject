...
public class CreateProjectScreen {
    ...
    public void initialize() {
        ...
        panelCreateProject.setBorder(BorderFactory.createTitledBorder("Create Project"));
        ...
        panelCreateProjectSuccess.setBorder(BorderFactory.createTitledBorder("Success Message"));
    ...
    private void setSuccessMessage() {
        ...
        b.append(
                "<p>You can now create an activity for this project or you can choose to create a new project.</p></html>");
    ...
    public void createProject() {
        ...
        if (name.equals("")) {
            ...
            if (listSearchResult.getSelectedIndex() == -1) {
                ...
                try {
                    planningApp.setProjectLeader(project.getProjectNumber(),
            ...
            if (startDayField.getText().equals("") || startMonthField.getText().equals("")
            ...
            if (endDayField.getText().equals("") || endMonthField.getText().equals("")
