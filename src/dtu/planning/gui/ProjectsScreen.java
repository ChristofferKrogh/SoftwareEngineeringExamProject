...
public class ProjectsScreen {
    ...
    public void initialize() {
        ...
        panelProjects.setBorder(BorderFactory.createTitledBorder("Projects"));
                ...
                if (e.getValueIsAdjusting() == false) {
                    ...
                    if (listSearchResult.getSelectedIndex() == -1) {
                        ...
                        lblSearchResultDetail
                                .setText(new ProjectPrinter(listSearchResult.getSelectedValue()).printDetail());
                    }
                }
            }
        });
    ...
    protected void searchProjects() {
        ...
        searchResults.clear();
        try {
            planningApp.searchForProjectsByName(searchField.getText()).forEach((m) -> {
