...
public class CreateActivitySteps {
    ...
    public CreateActivitySteps(ErrorMessageHolder errorMessageHolder, PlanningAppHolder planningAppHolder,
    ...
    public void theAssignedEmployeeIs(String initials)
        ...
        planningAppHolder.getPlanningApp().assignEmployee(projectHolder.getProject().getProjectNumber(),
                activityHolder.getActivity().getName(), actorHolder.getActor().getInitials(), employee.getInitials());
    }
    ...
    public void theProjectHasStartWeek(Integer numWeekYear, Integer year)
        ...
        planningAppHolder.getPlanningApp().editStartDateOfActivity(startWeek,
                projectHolder.getProject().getProjectNumber(), activityHolder.getActivity().getName(),
    ...
    public void theProjectHasEndWeek(Integer numWeekYear, Integer year)
        ...
        planningAppHolder.getPlanningApp().editEndDateOfActivity(endWeek, projectHolder.getProject().getProjectNumber(),
                activityHolder.getActivity().getName(), actorHolder.getActor().getInitials());
    ...
    public void theProjectLeaderEditsTheEndWeekOfTheProjectTo(Integer numWeekYear, Integer year)
        ...
        endWeek.setWeekDate(year, numWeekYear, GregorianCalendar.SUNDAY);
        try {
            planningAppHolder.getPlanningApp().editEndDateOfActivity(endWeek,
                    projectHolder.getProject().getProjectNumber(), activityHolder.getActivity().getName(),
                    actorHolder.getActor().getInitials());
        } catch (OperationNotAllowedException e) {
            errorMessageHolder.setErrorMessage(e.getMessage());
    ...
    public void theProjectLeaderEditsTheExpectedAmountOfHoursTo(Integer hours)
        ...
        planningAppHolder.getPlanningApp().editExpectedAmountOfHoursForActivity(expectedAmountOfHours,
                projectHolder.getProject().getProjectNumber(), activityHolder.getActivity().getName(),
                actorHolder.getActor().getInitials());
    }
    ...
    public void theActorDeletesFromTheActivity(String employeeInitials) {
        try {
            planningAppHolder.getPlanningApp().removeEmployeeFromActivity(projectHolder.getProject().getProjectNumber(),
                    activityHolder.getActivity().getName(), employeeInitials, actorHolder.getActor().getInitials());
    ...
    public void theStartWeekOfTheProjectIs(Integer numWeekYear, Integer year) {
        ...
        assertEquals(compareWeek.get(Calendar.WEEK_OF_YEAR),
                activityHolder.getActivity().getStartWeek().get(Calendar.WEEK_OF_YEAR));
    ...
    public void theEmployeeIsNotPartOfTheActivity() {
        assertFalse(activityHolder.getActivity().getAssignedEmployees().stream().map(e -> e.getInitials())
                .anyMatch(i -> i.equals(employeeHolder.getEmployee().getInitials())));
    }
