...
public class ReportTimeSteps {
    ...
    public ReportTimeSteps(PlanningAppHolder planningAppHolder, ErrorMessageHolder errorMessageHolder,
            ProjectHolder projectHolder, EmployeeHolder employeeHolder, TimeRegistrationHolder timeRegistrationHolder) {
    ...
    public void iReportHourOnOn(Integer amountOfTime, String activityName, Integer day, Integer month, Integer year)
