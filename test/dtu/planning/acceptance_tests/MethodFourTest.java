...
public class MethodFourTest {
	...
	@Test (expected = OperationNotAllowedException.class)
	public void testTimeRegistrationForNonexisitingEmployee() throws OperationNotAllowedException, ActivityNotFoundException, NotProjectLeaderException {
        // Setup
		PlanningApp planningApp = new PlanningApp();
	...
	@Test
	public void testRegisterTimeSuccessfully() throws OperationNotAllowedException, NotProjectLeaderException, ActivityNotFoundException {
        // Setup
		PlanningApp planningApp = new PlanningApp();
        ...
        assertTrue(planningApp.searchForActivity(projectNumber, "Activity").getTimeRegistrations().contains(timeRegistration));
	}
}
